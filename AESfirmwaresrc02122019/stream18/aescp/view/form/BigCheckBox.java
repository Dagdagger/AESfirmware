...
public class BigCheckBox extends JPanel {
	...
	public BigCheckBox(String text) {
    	setLayout(null);
		...
		ImageIcon icon = null;
		try {
			InputStream file = Button.class.getClassLoader().getResourceAsStream("resources/Unchecked.png");
			BufferedImage image = ImageIO.read(file);
			Image newImage = image.getScaledInstance(36, 36, Image.SCALE_DEFAULT);
			icon = new ImageIcon(newImage);
			checkBox.setIcon(icon);

			file = Button.class.getClassLoader().getResourceAsStream("resources/Checked.png");
